...
class CanceledDetailBookingScreen extends StatelessWidget {
  final Booking booking;

  const CanceledDetailBookingScreen({super.key, required this.booking});
...
Padding(
  ...
  child: Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      // Baris 1: Ikon bisa diklik, teks hanya label
      Row(
        ...
        children: [
          ...
          // 📝 TEKS "KEMBALI" — HANYA LABEL, TIDAK BISA DIKLIK
          Text(
            "Kembali",
            style: GoogleFonts.istokWeb(
              textStyle: TextStyle(
                color: Color(0xFF2158A1), // 🎨 WARNA BIRU MUDA
                fontSize: 20,
                    ...
                    Container(
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            // Gambar Klinik — SUDUT ATAS & BAWAH LENGKUNG
                            Padding(
                              padding: const EdgeInsets.only(top: 16, left: 16, right: 16),
                              child: ClipRRect(
                                borderRadius: BorderRadius.circular(16), // ⭐ SUDUT ATAS & BAWAH SERAGAM
                                child: AspectRatio(
                                  aspectRatio: 16 / 9,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      border: Border.all(
                                        color: Color(0xFFE94242), // 🎨 BORDER MERAH
                                      ),
                                    ),
                                    child: Text(
                                      "Dibatalkan", // ✅ HARDCODE UNTUK STATUS INI
                                      style: GoogleFonts.instrumentSans(
                                        textStyle: const TextStyle(
                                        fontSize: 10,
                                        color: Color(0xFFE94242), // 🎨 TEKS MERAH
                                        fontWeight: FontWeight.bold,
                                        )
                                      ),
                                    ),
